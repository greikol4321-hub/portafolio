...
export default function Home() {
  return <div className="wander-page">
    <ScrollProgress />
    <header className="wander-header"><a className="brand code-brand" href="#inicio" aria-label="Ir al inicio"><CodeMark /><span>Greikol<br /><small>Quesada · dev</small></span></a><nav aria-label="Navegación principal"><a href="#trabajo">Proyectos</a><a href="#experiencia">Trayectoria</a><a href="#perfil">Perfil</a><a href="#contacto">Contacto</a></nav><a className="header-note" href="https://mail.google.com/mail/?view=cm&fs=1&to=greikolamador@gmail.com" target="_blank" rel="noreferrer">SISTEMAS A MEDIDA<br /><span>QUEPOS, CR</span></a></header>
    <main id="inicio">
      <section className="portfolio-hero"><Reveal><p className="eyebrow">PORTAFOLIO / DESARROLLO WEB / 2026</p><h1><TextReveal text="Software para" /><br /><em><TextReveal text="problemas reales." delay={0.12} /></em></h1><p className="lead">Diseño y desarrollo sistemas web para colegios, negocios y turismo: entradas, paneles y herramientas pensadas para funcionar de verdad.</p><p className="hero-kicker"><span className="status-dot" aria-hidden="true" /> ¿Tienes un proceso que ordenar?</p><div className="hero-links"><a className="hero-primary" href="#trabajo">Ver proyectos</a><a href="https://github.com/greikol4321-hub" target="_blank" rel="noreferrer">GitHub ↗</a></div></Reveal><Reveal delay={0.15} direction="left" className="proof-board">
...
<p className="proof-note">Sistemas hechos para usarse, no solo para mostrarse.</p>
</Reveal></section>
      <section className="signal-strip"><span>QUEPOS, COSTA RICA</span><span>FLASK · NEXT.JS · SUPABASE</span><span>ENTRADAS · PANELES · RESERVAS</span><span>HECHO A MEDIDA</span></section>
      ...
      <section className="about-section" id="perfil"><Reveal><p className="eyebrow">PERFIL</p><h2><TextReveal text="Menos fricción." /><br /><em><TextReveal text="Mejores resultados." delay={0.08} /></em></h2></Reveal><Reveal delay={0.08} className="about-copy"><p>Soy Greikol Yanfred Quesada Amador, desarrollador web de Quepos. Construyo herramientas digitales para que un negocio pueda vender, administrar y atender mejor.</p><p>Trabajo con responsabilidad y comunicación clara: entiendo el problema, diseño el flujo y entrego sistemas que se pueden abrir, probar y mantener sin complicaciones.</p><div className="profile-facts"><span><b>Especialidad</b>Sistemas web a medida</span><span><b>Enfoque</b>Procesos simples y claros</span><span><b>Fortalezas</b>Equipo · liderazgo · orden</span></div></Reveal></section>
