...
export default function Home() {
  return <div className="wander-page">
    ...
    <main id="inicio">
      <section className="postcard-hero" aria-label="Presentación"><div className="postcard-scene"><div className="sun" /><div className="mountain mountain-back" /><div className="mountain mountain-front" /><div className="lake" /><div className="cabin"><i /><b /><span /></div><div className="tree tree-one" /><div className="tree tree-two" /><div className="postcard-grain" /></div><div className="postcard-label"><span className="brand-mark">✳</span><strong>Greikol Quesada</strong><small>DESARROLLO WEB · QUEPOS</small></div><div className="postcard-phone">+506 6127-2074<br /><small>PORTAFOLIO / 2026</small></div></section>
      <nav className="file-nav" aria-label="Secciones"><span className="file-home">◆ BASECAMP</span><a href="#trabajo">Qué hago</a><a href="#proceso">Cómo lo hago</a><a href="#perfil">Quién soy</a><a href="#contacto">Hablemos</a></nav>
