...
export default function Home() {
  return <div className="wander-page">
    ...
    <main id="inicio">
      <section className="postcard-hero" aria-label="Presentación"><div className="postcard-scene"><div className="sun" /><div className="mountain mountain-back" /><div className="mountain mountain-front" /><div className="lake" /><div className="cabin"><i /><b /><span /></div><div className="tree tree-one" /><div className="tree tree-two" /><div className="postcard-grain" /></div></section>
